...
class Tree:
    ...
    def get_sse(self, fit=True, verbose=False):
        ...
        for ds in self.x:
            ...
            try:
                """print(str(self))
                print('ar',variables,ar)
                ode=feval(0.,*ar)
                for i,j in zip(this_y , feval(0,*ar)):
                    print(i,j)
                for l,m in zip(this_y,feval(0,*ar)):
                    print(ds,l,m,l-m)"""
                se = np.square(this_y - feval(0, *ar))
                """print(str(self))
                print('se',sum(se))"""
        ...
        # Done
        # print('ex-sse mean',ex,np.mean(s))
        return self.sse
